...
class Welcome extends CI_Controller {
	...
	/**
	 * @api {get} /Welcome/check_userlist Get user list from mysql
	...
	public function check_userlist()
    {
        ...
        $request_target = $this->input->get('name');
	...
	/**
	 * @api {get} /Welcome/signup_user/:name/:password Signup
	 * @apiName signup
    ...
    public function signup_user()
    {
        ...
        $request_pass = $this->input->get('password');
        // setting
        $this->config->load('ate_setting', TRUE);
        $base_setting = $this->config->item('ate_setting');
    ...
    public function init_setting($setting_file, $type)
    {
        ...
        $this->config->load('ate_setting', TRUE);
        $init_setting = $this->config->item('ate_setting');
        if ( 'settings' == $type )
        {
            $str = $init_setting['init_file_setting']['interface'] . "\n";
            fwrite($fp, $str);
            $str = $init_setting['init_file_setting']['timeout'] . "\n";
            fwrite($fp, $str);
            $str = $init_setting['init_file_setting']['server'] . "\n";
            fwrite($fp, $str);
            $str = $init_setting['init_file_setting']['serverUrl'] . "\n";
            fwrite($fp, $str);
        }
